...
public class AccountInfoActivity$$ViewBinder<T extends com.example.objLoader.activity.AccountInfoActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131689688, "field 'ivRightTitleBar' and method 'onClick'");
    target.ivRightTitleBar = finder.castView(view, 2131689688, "field 'ivRightTitleBar'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
