...
import com.example.objLoader.utils.lib.ScreenInfo;
import com.example.objLoader.utils.lib.WheelTime;
...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
	...
	WheelTime wheelTime;
	private View btnSubmit, btnCancel,ll_pw_time;
...
//		this.setAnimationStyle(R.style.timepopwindow_anim_style);
		...
		ll_pw_time=rootView.findViewById(R.id.ll_pw_time);
		// ----时间转轮
