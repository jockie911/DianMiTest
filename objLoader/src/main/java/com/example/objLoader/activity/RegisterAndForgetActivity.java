	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			...
			case R.id.iv_eye_pwd:
				isShowPsd = !isShowPsd;
				ivEyePwd.setImageResource(isShowPsd? R.drawable.opened_eye:R.drawable.closed_eye);
				et_register_password.setInputType(isShowPsd ? InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD :
						InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
				String s = et_register_password.getText().toString();
				et_register_password.setSelection(TextUtils.isEmpty(s)? 0 : s.length());
				break;
		}
	}
