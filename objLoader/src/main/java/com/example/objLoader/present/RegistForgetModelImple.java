...
import com.example.objLoader.present.view.RegistForgetModel;
...
public class RegistForgetModelImple<T extends BaseActivity> implements RegistForgetModel {
    ...
    public void bindMobile(T mActivity,String code, final String mobile, final IBindMobile listener) {
